	...
	<div class = "container-fluid">
		<div class = "row page-title-row">
			...
			<div class = "col-md-6 text-right">
				<a href = "/admin/tag/create" class = "btn btn-success btm-md">
					...
					<tbody>
						@foreach ($tags as $tag)
							<tr>
								...
								<td class = "hidden-sm">@if ($tag->reverse_direction)
										Reverse
									@else
										Normal
									@endif
